...
fn base_pose(status: RuntimeStatus) -> Vec<CanonicalParam> {
    match status {
        ...
        RuntimeStatus::CodexNotInstalled => vec![
            ...
            param("ParamEyeOpen", 0.0, 0.9),
            param("ParamMouthOpenY", 0.0, 0.04),
        ...
        RuntimeStatus::Coding => vec![
            param("ParamAngleX", 0.12, 0.0),
            param("ParamBodyAngleX", 0.08, 0.0),
            param("ParamMouthOpenY", 0.0, 0.32),
            param("ParamBreath", 0.0, 0.5),
        ],
        RuntimeStatus::Question => vec![
            param("ParamAngleX", 0.04, 0.0),
            param("ParamBodyAngleX", -0.04, 0.0),
            param("ParamEyeOpen", 0.0, 0.98),
            param("ParamMouthOpenY", 0.0, 0.18),
            param("ParamBreath", 0.0, 0.5),
        ],
        RuntimeStatus::Complete => vec![
            param("ParamAngleX", 0.0, 0.0),
            param("ParamBodyAngleX", 0.05, 0.0),
...
fn layers(status: RuntimeStatus) -> Vec<MotionLayer> {
    match status {
        ...
        | RuntimeStatus::Complete => breathing_layers().to_vec(),
    }
}
...
fn idle_keyframes() -> [PhaseParams; 4] {
    [
        ...
        [
            param("ParamAngleX", 0.1, 0.0),
            param("ParamBodyAngleX", 0.05, 0.0),
            param("ParamEyeOpen", 0.0, 0.7),
            param("ParamEyeMove", 0.42, 0.0),
            param("ParamMouthOpenY", 0.0, 0.02),
        ...
        [
            param("ParamAngleX", -0.06, 0.0),
            param("ParamBodyAngleX", -0.08, 0.0),
            param("ParamEyeOpen", 0.0, 0.55),
            param("ParamEyeMove", 0.45, 0.0),
            param("ParamMouthOpenY", 0.0, 0.18),
            param("ParamMouthSmile", 0.0, 0.0),
            param("ParamArmLeft", 0.5, 0.0),
            param("ParamArmRight", 0.5, 0.0),
            param("ParamBreath", 0.0, 0.72),
            param("ParamBodyXMove", 0.48, 0.0),
            param("ParamTailMove", 0.38, 0.0),
        ],
        // Phase 3 (7–11s): Looking around lazily, searching for something
        [
            param("ParamAngleX", -0.16, 0.0),
            param("ParamBodyAngleX", -0.04, 0.0),
            param("ParamEyeOpen", 0.0, 0.92),
            param("ParamEyeMove", 0.62, 0.0),
            param("ParamMouthOpenY", 0.0, 0.04),
            param("ParamMouthSmile", 0.0, 0.08),
            param("ParamArmLeft", 0.5, 0.0),
            param("ParamArmRight", 0.48, 0.0),
            param("ParamBreath", 0.0, 0.5),
            param("ParamBodyXMove", 0.52, 0.0),
            param("ParamTailMove", 0.6, 0.0),
        ],
        // Phase 4 (11–14s): Settling back to boredom
        [
            param("ParamAngleX", 0.04, 0.0),
            param("ParamBodyAngleX", 0.02, 0.0),
            param("ParamEyeOpen", 0.0, 0.76),
            param("ParamEyeMove", 0.48, 0.0),
            param("ParamMouthOpenY", 0.0, 0.03),
            param("ParamMouthSmile", 0.0, 0.0),
            param("ParamArmLeft", 0.5, 0.0),
            param("ParamArmRight", 0.5, 0.0),
            param("ParamBreath", 0.0, 0.5),
            param("ParamBodyXMove", 0.5, 0.0),
            param("ParamTailMove", 0.48, 0.0),
        ],
    ]
}
...
fn thinking_keyframes() -> [PhaseParams; 4] {
    [
        ...
        [
            param("ParamAngleX", -0.22, 0.0),
            param("ParamBodyAngleX", -0.08, 0.0),
            param("ParamEyeOpen", 0.0, 0.78),
            param("ParamEyeMove", 0.38, 0.0),
            param("ParamMouthOpenY", 0.0, 0.03),
            param("ParamMouthSmile", 0.0, 0.0),
            param("ParamArmLeft", 0.75, 0.0),
            param("ParamArmRight", 0.25, 0.0),
            param("ParamBreath", 0.0, 0.55),
            param("ParamBodyXMove", 0.47, 0.0),
            param("ParamTailMove", 0.5, 0.0),
        ],
        ...
        [
            ...
            param("ParamBodyAngleX", 0.04, 0.0),
            param("ParamEyeOpen", 0.0, 0.98),
            param("ParamEyeMove", 0.65, 0.0),
            param("ParamMouthOpenY", 0.0, 0.16),
            param("ParamMouthSmile", 0.0, 0.2),
            param("ParamArmLeft", 0.58, 0.0),
            param("ParamArmRight", 0.42, 0.0),
            param("ParamBreath", 0.0, 0.62),
            param("ParamBodyXMove", 0.54, 0.0),
            param("ParamTailMove", 0.7, 0.0),
        ],
        // Phase 3 (6.5–9.5s): Head scratch, "nah…"
        [
            param("ParamAngleX", 0.2, 0.0),
            param("ParamBodyAngleX", 0.12, 0.0),
            param("ParamEyeOpen", 0.0, 0.84),
            param("ParamEyeMove", 0.4, 0.0),
            param("ParamMouthOpenY", 0.0, 0.24),
            param("ParamMouthSmile", 0.0, 0.0),
            param("ParamArmLeft", 0.5, 0.0),
            param("ParamArmRight", 0.85, 0.0),
            param("ParamBreath", 0.0, 0.42),
            param("ParamBodyXMove", 0.56, 0.0),
            param("ParamTailMove", 0.3, 0.0),
        ],
        // Phase 4 (9.5–12s): Transition back to crossed-arms pose
        [
            param("ParamAngleX", -0.08, 0.0),
            param("ParamBodyAngleX", -0.02, 0.0),
            ...
            param("ParamArmRight", 0.32, 0.0),
            param("ParamBreath", 0.0, 0.52),
            param("ParamBodyXMove", 0.49, 0.0),
            param("ParamTailMove", 0.45, 0.0),
        ],
    ]
}
...
pub fn create_motion_targets(status: RuntimeStatus, elapsed_seconds: f32) -> Vec<MascotParamValue> {
    match status {
        ...
        RuntimeStatus::Thinking => return create_thinking_targets(elapsed_seconds),
        _ => {}
    }
...
mod mascot_motion_tests {
    ...
    use super::{create_motion_targets, IDLE_LOOP_SECONDS, THINKING_LOOP_SECONDS};
    ...
    #[test]
    fn non_idle_statuses_keep_breathing_motion() {
        for status in [
            RuntimeStatus::CodexNotInstalled,
            RuntimeStatus::Coding,
            RuntimeStatus::Question,
            ...
            let first = create_motion_targets(status, 0.0);
            let second = create_motion_targets(status, std::f32::consts::FRAC_PI_2);
